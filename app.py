...
st.write("<h1>CROP CARE - AI Based Plant Disease Detection using Image Classification</h1>", unsafe_allow_html=True)
...
with st.sidebar:
    ...
    st.info("""
        ...
        # Contact
        For inquiries, you can mail us [here](mailto:kumar.23bai10076@vitbhopal.ac.).
        """)
...
{constants.FERTILIZER_RECOMMENDATIONS[label]}

##### Details:
{constants.FERTILIZER_DETAILS[label]}
        
##### REFERENCE:
{constants.REFERENCE[label]}     
        """)
